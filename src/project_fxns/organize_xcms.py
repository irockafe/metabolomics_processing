...
# TODO maybe change name to xcms_organize
# since these fxns are all basically about organizing data
class Xcms_organize():
    ...
    def subset(self, list_like, num_subsets=5):
        # split data into {num} equal-length groups
        # i.e. given a list of mean feature intensities,
        # split it into 5 groups
        pass
    ...
    def subset_pvals_hist(self, pvals, covariate, num_subsets=5):
        # stratifies covariate using subset() 
        # then splits pvals accordingly, and plots a multi-hist
        pass


    def volcano(self):
        # volcano plot, maybe taking into account variance?
        pass


# some data examination pre-plots
# p-val histograms
# plots of those pvals with other variables,
# i.e. mean intensity, variance, etc
