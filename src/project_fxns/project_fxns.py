...
class Storage():
    '''
    When a user-provided user_settings.yml file is present at
    /home/user_input/, this class manages checking
    if a bucket exists, and synching to/from those buckets
    '''
    def __init__(self):
...
def class_names(study, assay,
    ...
    #     MS Assay name, class labels for MTBLS projects
